...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.wllanpj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get('/', (req, res) => {
    res.send('Hello from my smarty pant server');
});
